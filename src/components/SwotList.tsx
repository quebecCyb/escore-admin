...
const SwotList = () => {
    ...
    const analyze = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const response = await fetch('http://localhost:5000/swot/csf', {
                method: 'POST',
                headers: {
        ...
        try {
            // Make a POST request to the server
            const response = await fetch('http://localhost:5000/swot/mission', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
        ...
        try {
            // Make a POST request to the server
            const response = await fetch('http://localhost:5000/swot/vision', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
        ...
        try {
            // Make a POST request to the server
            const response = await fetch('http://localhost:5000/swot/strategy', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
